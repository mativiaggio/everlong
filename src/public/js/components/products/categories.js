...
export function productsCategories(categories) {
  ...
  parentCategories.forEach((parentCategory) => {
    ...
    function categoryItem(category) {
      return `
        <a href="/productos/categoria/${category.slug}" class="hover:bg-[#f9fafb] cursor-pointer">
          <li class="relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900" role="option hover:bg-[#f9fafb] cursor-pointer">
    ...
    html += `
      <a href="/productos/categoria/${parentCategory.slug}" class="hover:bg-[#f9fafb] cursor-pointer">
        <li class="relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900" role="option hover:bg-[#f9fafb] cursor-pointer">
          <div class="flex items-center">
